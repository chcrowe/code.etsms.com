...
func ParseG1AuthorizationMessageResponse(s string) (*G1AuthorizationMessageResponse, int) {
	...
	//t.ApprovalCode = strings.Replace(strings.Replace(t.ApprovalCode, "VITAL", "ETSMS", -1), "TAS", "ETS", -1)

	//t.AuthorizationResponseText = strings.Replace(strings.Replace(t.AuthorizationResponseText, "VITAL", "ETSMS", -1), "TAS", "ETS", -1)
