...
import (
	// "bufio"
	"bytes"
	"code.etsms.com/p/auth"
	"code.etsms.com/p/bitwise"
	etsbytes "code.etsms.com/p/bytes"
	"code.etsms.com/p/filesys"
	"code.etsms.com/p/list"
	. "code.etsms.com/p/tsys/virtualnet"
	"crypto/sha512"
	// "crypto/tls"
	"fmt"
	"io"
...
var TESTAUTHFILEPATH string = "c:\\Projects\\Go\\src\\code.etsms.com\\p\\tsys\\tsysauths2.dat"
...
var messageTests = []MessageTest{
	...
	{"T4.99999588800000083559991515QR84084020165    007055999N216593KD4388570000000006=151210100000100000000000000004A0000000000000010000CTC TESTING - RETAIL     Sterling     VA      090814173222425163142282142282 V51234567891324000000112233207Z020000136B290034", "U4.N599915155216500TAS384090814173223APPROVAL TAS384 0425163142282 000000000214534    999995        14228250908020034A ", ""},
}
...
func NoTestUrls(t *testing.T) {
	uri, _ := url.Parse("https://pos.etsemoney.com/POSCP3/main.asp?a=AUTHORIZE_ONLINE&VendorName=ACME Corp&")
