...
func DoNvpRequest() {
	request := auth.RequestMessage{Action: "AUTHORIZE_ONLINE", ClientID: "5562", MasterKey: "535061", TrackData: "4123456789012349=171210100000000000", TransactionAmount: "10.00"}
...
func CreateVisaRetailAuthorization() string {
	...
	customeraccountdata := tsys.NewCustomerDataField(tsys.FullMagneticStripeReadAndTransmitTrack2, "", "4123456789012349=171210100000000000")
